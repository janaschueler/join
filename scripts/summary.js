...
/**
 * Updates the inner HTML of the element with the ID 'urgent_content' to display the number of tasks
 * with a priority of "urgent". It filters the `allTasks` array to count the tasks marked as urgent
 * and displays this count inside a div element.
 */
function findUrgent () {
